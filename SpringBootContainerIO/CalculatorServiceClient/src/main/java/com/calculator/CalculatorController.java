...
public class CalculatorController {
	...
	public String floatAddition(@RequestBody Number number) {
		...
		return calculatorServiceClient.callService(number.getFirstNumber(), number.getSecondNumber(),"/addition/float/");
	}
	...
	public String floatSubstraction(@RequestBody Number number) {
		CalculatorServiceClient calculatorServiceClient = new CalculatorServiceClient();
		return calculatorServiceClient.callService(number.getFirstNumber(), number.getSecondNumber(),"/substraction/float/");
	}
	...
	public String floatMultiplication(@RequestBody Number number) {
		CalculatorServiceClient calculatorServiceClient = new CalculatorServiceClient();
		return calculatorServiceClient.callService(number.getFirstNumber(), number.getSecondNumber(),"/multiplication/float/");
	}
	...
	public String floatDivision(@RequestBody Number number) {
		CalculatorServiceClient calculatorServiceClient = new CalculatorServiceClient();
		return calculatorServiceClient.callService(number.getFirstNumber(), number.getSecondNumber(),"/division/float/");
	}
	// -----------------------------------
	...
	public String intAddition(@RequestBody Number number) {
		CalculatorServiceClient calculatorServiceClient = new CalculatorServiceClient();
		return calculatorServiceClient.callService(number.getFirstNumber(), number.getSecondNumber(),"/addition/int/");
	}
	...
	public String intSubstraction(@RequestBody Number number) {
		CalculatorServiceClient calculatorServiceClient = new CalculatorServiceClient();
		return calculatorServiceClient.callService(number.getFirstNumber(), number.getSecondNumber(),"/substraction/int/");
	}
	...
	public String intMultiplication(@RequestBody Number number) {
		CalculatorServiceClient calculatorServiceClient = new CalculatorServiceClient();
		return calculatorServiceClient.callService(number.getFirstNumber(), number.getSecondNumber(),"/multiplication/int/");
	}
	...
	public String intDivision(@RequestBody Number number) {
		CalculatorServiceClient calculatorServiceClient = new CalculatorServiceClient();
		return calculatorServiceClient.callService(number.getFirstNumber(), number.getSecondNumber(),"/division/int/");
	}
}
